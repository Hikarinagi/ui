...
<template>
  ...
  >
    <template #header>
      <Switch v-model="knownTotal" :disabled="loading">Known total</Switch>
    ...
    <template #empty>
      <Empty :title="failed ? 'Loading failed' : 'No data'" size="sm">
        <template v-if="failed" #actions><Button size="sm" @click="load">Retry</Button></template>
      </Empty>
    </template>
  </DataList>
</template>
