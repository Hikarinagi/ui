  ...
  compoundVariants: [
    {
      variant: 'solid',
      tone: 'accent',
      class: 'bg-accent text-accent-on [--hn-state-color:var(--hn-accent-on)]',
    },
    {
      variant: 'solid',
      tone: 'neutral',
      class: 'bg-neutral-solid text-neutral-solid-on [--hn-state-color:var(--hn-neutral-solid-on)]',
    },
    {
      variant: 'solid',
      tone: 'danger',
      class: 'bg-danger text-danger-on [--hn-state-color:var(--hn-danger-on)]',
    },
    ...
    { variant: 'ghost', tone: 'accent', class: 'text-accent-text' },
