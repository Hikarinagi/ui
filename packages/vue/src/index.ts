...
export { default as PaginationContent } from './components/pagination/PaginationContent.vue'
export { default as PaginationInfo } from './components/pagination/PaginationInfo.vue'
export { default as PaginationSize } from './components/pagination/PaginationSize.vue'
export { default as PaginationJump } from './components/pagination/PaginationJump.vue'
export type { PaginationChange, PaginationState } from './components/pagination/types'
...
export type { AnchorItem } from './components/anchor/types'
