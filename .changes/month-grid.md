...
Add an SSR-ready monthly display table with caller-owned day content and actions, controlled month navigation, month and year shortcuts, date bounds, localized week headings, and visible-range events. Share calendar header controls while preserving existing date-selection behavior.
